...
public class AlterarService extends JFrame {

	private JPanel contentPane;
	private JPasswordField campo_senha_2;
	private JPasswordField campo_senha_1;
	private static AlterarService frame;
		/**
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					frame = new AlterarService(usuarioBusca);
	 ...
	 * Create the frame.
	 */
	public AlterarService(UsuarioEntity pUsuario) {
		...
		btn_alterar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				UsuarioEntity usuarioAlteracaoSenha = new UsuarioEntity();
				
				usuarioAlteracaoSenha = usuarioUserCase.alterarSenha(1, pUsuario,campo_senha_1.getText(), campo_senha_2.getText());
				
				if(usuarioAlteracaoSenha.getMsg_erro().trim().equals("") == true) {
					LoginService window = new LoginService();
		...
		lbl_senha_mostra_1.setIcon(new ImageIcon(AlterarService.class.getResource("/br/elton/imagens/pngwing.com_3.png")));
		...
		lbl_senha_mostra_2.setIcon(new ImageIcon(AlterarService.class.getResource("/br/elton/imagens/pngwing.com_3.png")));
